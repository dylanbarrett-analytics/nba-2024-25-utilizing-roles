...
For the modern NBA fan, checking a player's stat line for a game usually begins with points, rebounds, and assists. These are the primary statistics that measure raw on-court *output*. Superstars are expected to put up big numbers, but what about players who have smaller roles in a team's offense? Traditional box scores may fail to capture their true impact.
